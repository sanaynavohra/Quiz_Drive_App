...
import 'package:quiz_drive/page-1/recruiter.dart';
            ...
            children: [
              UserAccountsDrawerHeader(
                decoration: BoxDecoration(
                  color: Colors.indigo[200], // Change the color to your preferred background color
                ),
        ...
        child: Column(
          children: [
            ...
            TextButton(
              ...
              child: Text(
                "Create Quiz For Candidates",
                style: TextStyle(
                  color: Colors.black, // Change the color to your preferred color
                  fontSize: 16, // You can also adjust the font size
                  fontWeight: FontWeight.bold, // You can apply different styles as needed
                ),
              )
                ...
                children: [
                  Container(
                    ...
                    child: GestureDetector(
                      ...
                      child: Image.asset(
                        'assets/page-1/images/results.jpg',
                        fit: BoxFit
                            .cover, // Use BoxFit to fill the container with the image
                      ),
                    ),
